        ...
        userProfiles: [
            {
                ...
                "fullName": "You",
                "name": "You",
                "pic": "http://mysticccs.github.io/candycrush.king.com/odus100x100.png",
                "picSquare": "http://mysticccs.github.io/candycrush.king.com/odus50x50.png",
                "countryCode": "CA",
                "topEpisode": 1,
                "topLevel": 1,
                "totalStars": 0,
...
window.MockRequest = function(url, params) {
    ...
    try {
        switch (url) {
            case "http://mysticccs.github.io/candycrush.king.com/api/gameInitLight": {
                result = gameInitLight()
                break;
            } case "http://mysticccs.github.io/candycrush.king.com/api/handOutItemWinnings": {
            ...
            case "http://mysticccs.github.io/candycrush.king.com/api/useItemsInGame": {
                //console.log('adding this')
                let boostersAdd = JSON.parse(decoded['arg0'])
                //console.log(boostersAdd)
            ...
            case "http://mysticccs.github.io/candycrush.king.com/api/gameStart2": {
                result = gameStart(decoded['arg0'], decoded['arg1'])
                break
            }
            case "http://mysticccs.github.io/candycrush.king.com/api/getLevelToplist": {
                result = getToplist(decoded['arg0'], decoded['arg1'])
                break;
            }
            case "http://mysticccs.github.io/candycrush.king.com/api/gameEnd3": {
                result = gameEnd(JSON.parse(decoded['arg0']))
                break
            }
            case "http://mysticccs.github.io/candycrush.king.com/api/poll": {
                result = {currentUser: getCurrentUser()}
                break;
            }
            case "http://mysticccs.github.io/candycrush.king.com/api/getMessages": {
                result = {events: [], currentUser: getCurrentUser()}
                break;
            }
            case "http://mysticccs.github.io/candycrush.king.com/api/getBalance": {
                result = getBalance()
                break;
            }
            case "http://mysticccs.github.io/candycrush.king.com/api/unlockItem": {
                result = addBoosters([{type:decoded['arg0'], amount:0}], true)
                break
            }
            case "http://mysticccs.github.io/candycrush.king.com/candycrushapi/getWebFileUrl": {
            ...
            case "http://mysticccs.github.io/candycrush.king.com/candycrushapi/getGameModes": {
            ...
            case "http://mysticccs.github.io/candycrush.king.com/candycrushapi/getGameModePerLevel": {
                result = gameModesPerLevel
                break
            }
            case "http://mysticccs.github.io/candycrush.king.com/candycrushapi/getCandyProperties": {
                result = {candyProperties: getCandyProperties()}
                break
            }
            case "http://mysticccs.github.io/candycrush.king.com/candycrushapi/getLevelAbTests": {
                result = []
                break
            }
            case "http://mysticccs.github.io/candycrush.king.com/candycrushapi/setCandyProperty": {
                setCandyProperty(decoded['arg0'],decoded['arg1'])
                break
            }
            case "http://mysticccs.github.io/candycrush.king.com/candycrushapi/deliverInitialHardCurrencyGiftForIntroPop": {
            ...
            case "http://mysticccs.github.io/candycrush.king.com/candycrushapi/getWheelOfBoosterPrize": {
                result = getWheelPrize()
                break
            }
            case "http://mysticccs.github.io/candycrush.king.com/api/setSoundFx": {
                let currentUser = get('currentUser')
                currentUser.soundFx = JSON.parse(decoded['arg0'])
                set('currentUser', currentUser)
                break
            }
            case "http://mysticccs.github.io/candycrush.king.com/api/setSoundMusic": {
                let currentUser = get('currentUser')
